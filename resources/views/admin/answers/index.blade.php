                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Manajemen Master Data Answer</h4>
                                    <p class="card-description">Berikut adalah list master data<code>answer</code></p>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            @foreach ($answers as $answer)
                                                <tr data-id="{{ $answer->id }}">
                                                    ...
                                                    <td>
                                                        <form action="{{ route('admin.answers.destroy', $answer->id) }}" method="POST" class="d-inline delete-form">
                                                            @csrf
                                                            @method('DELETE')
